...
var longitude = 174.7705078,
  latitude = -41.28606239;
...
Physics.prototype.addPolygons = function(polygons, scale){
...
Physics.prototype.getLatitude = function(){
  var y = this.playerBody.GetPosition().y;

  return tile2lat(20517 + 1.0 / 4096 * y,15);

  y = 170.1022 / (4096 * 32768) * y;

  return -y + -41.28606239;
}

Physics.prototype.getLongitude = function(){
  var x = this.playerBody.GetPosition().x;

  x = 360.0 / (4096 * 32768) * x;

  return x + 174.7705078;
}

$.get('./tiles/physics-15-32292-20517.json', function(tile){
...
function startRenderLoop(physics){
  $("canvas").show();
  ...
  setInterval(function(){
    ...
    map.setBearing(physics.heading + 90);
    map.setCenter([physics.getLatitude(), physics.getLongitude()]);
  }, 1000 / 60);
