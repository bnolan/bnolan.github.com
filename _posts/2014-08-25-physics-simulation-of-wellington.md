...
If you're trying to make the code work on your own, note that I had to have hacked up `createBucket` to always set `bucket.interactive = true` - since that didn't seem to work correctly in the current master branch on mapbox-gl-js. This is taking way longer than I expected - I hope this is a cool game mechanic walking around the city. :)